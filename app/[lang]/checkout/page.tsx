...
function CheckoutPageContent() {
  ...
  const [isCardPaymentEnabled, setIsCardPaymentEnabled] = useState(true);
  ...
  const handleSubmitOrder = async () => {
    // Prevent card payment if it's disabled
    if (paymentMethod === "card" && !isCardPaymentEnabled) {
      toast.error("Η πληρωμή με κάρτα δεν είναι διαθέσιμη", {
        description: "Παρακαλώ επιλέξτε πληρωμή με μετρητά",
      });
