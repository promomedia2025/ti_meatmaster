...
const featuredMenuIds = [359, 371, 460, 411, 466, 369, 372, 380];
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed">
                ...
                <span className="font-medium text-orange-400">
                  Παρακαλούμε ζητήστε ανανέωση του κωδικού σας από το "Ξεχάσατε τον κωδικό πρόσβασης" 
                </span> ή δημιουργήστε νέο λογαριασμό για να συνεχίσετε τις παραγγελίες σας.
              </p>
