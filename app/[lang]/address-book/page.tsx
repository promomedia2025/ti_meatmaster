      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <button
            ...
            className="flex items-center gap-3 bg-[#9E2E29] hover:bg-[#601B19] text-white px-6 py-3 rounded-lg transition-colors"
          >
          ...
          <div className="space-y-4">
            {!Array.isArray(addresses) || addresses.length === 0 ? (
              <div className="text-center py-12">
                ...
                <button
                  onClick={() => setIsAddModalOpen(true)}
                  className="bg-[#9E2E29] hover:bg-[#601B19] text-white px-6 py-3 rounded-lg transition-colors"
                >
                  Προσθήκη Διεύθυνσης
                </button>
              </div>
