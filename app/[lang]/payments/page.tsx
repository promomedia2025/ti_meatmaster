...
export default function PaymentMethodsPage() {
  return (
    <main className="min-h-screen bg-black text-zinc-200 font-sans selection:bg-[#7C2429]/30">
      ...
      <div className="bg-zinc-900 border-b border-zinc-800">
        <div className="max-w-4xl mx-auto px-4 py-8 flex items-center gap-6">
          <Link
            href="/"
            className="p-2 bg-black border border-zinc-800 rounded-xl hover:border-[#7C2429] transition-all text-zinc-400 hover:text-white shrink-0"
          >
          ...
          <div className="w-16 h-16 bg-black rounded-full flex items-center justify-center shrink-0 border-4 border-zinc-900 shadow-xl">
            <CreditCard className="w-6 h-6 text-[#7C2429]" />
          </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 text-lg leading-relaxed text-zinc-400 space-y-12">
        ...
        <section className="space-y-6">
          <h2 className="text-xl font-bold text-white border-l-4 border-[#7C2429] pl-4 flex items-center gap-2">
            <ShieldCheck className="w-5 h-5 text-[#7C2429]" />
            Με πιστωτική κάρτα
          </h2>
          <p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-4 hover:border-[#7C2429] transition-colors">
              <h3 className="text-zinc-100 font-bold flex items-center gap-2 text-sm uppercase tracking-wider">
                <Lock className="w-4 h-4 text-[#7C2429]" />
                3D Secure & SCA
              </h3>
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-4 hover:border-[#7C2429] transition-colors">
              <h3 className="text-zinc-100 font-bold flex items-center gap-2 text-sm uppercase tracking-wider">
                <ShieldCheck className="w-4 h-4 text-[#7C2429]" />
                PCI DSS
              </h3>
              <p className="text-sm leading-relaxed">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-4 hover:border-[#7C2429] transition-colors">
              <h3 className="text-zinc-100 font-bold flex items-center gap-2 text-sm uppercase tracking-wider">
                <Smartphone className="w-4 h-4 text-[#7C2429]" />
                Κρυπτογράφηση
              </h3>
              <p className="text-sm leading-relaxed">
        ...
        <section className="space-y-8">
          <h2 className="text-xl font-bold text-white border-l-4 border-[#7C2429] pl-4">
          ...
          <div className="grid gap-6 text-base">
            {[
              ...
              <div key={idx} className="flex gap-6 group">
                {/* Πιο φωτεινό κόκκινο για τα νούμερα (text-[#C83A41]) */}
                <div className="text-[#C83A41] font-black text-3xl opacity-80 group-hover:opacity-100 transition-opacity tabular-nums">
                  {item.step}
                </div>
                <div>
        ...
        <section className="bg-gradient-to-br from-[#7C2429]/20 to-transparent border border-[#A32E35] rounded-2xl p-8 space-y-6">
          <h2 className="text-xl font-bold text-white flex items-center gap-2">
            <ClipboardCheck className="w-5 h-5 text-[#C83A41]" />
            Σημαντικές Σημειώσεις
          </h2>
          <div className="space-y-4">
            <div className="flex items-start gap-3 text-sm">
              <div className="p-1 bg-[#7C2429]/40 rounded-md text-[#C83A41] shrink-0">✓</div>
            ...
            <div className="mt-4 p-4 bg-black/60 rounded-lg border border-zinc-800/80 text-sm italic">
              <strong className="text-[#C83A41] not-italic block mb-1">Ασφάλεια Δεδομένων:</strong>
