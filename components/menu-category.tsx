          ...
          >
            ...
            <div className="relative w-32 h-32 flex-shrink-0 p-2.5">
              ...
              <button
                ...
                className="absolute top-0 right-0 w-10 h-10 bg-[#9E2E29] rounded-full flex items-center justify-center hover:bg-[#601B19] transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-lg border-2 border-gray-900"
              >
