      ...
      >
          ...
          {!menuItem && (
            <div className="flex items-center justify-center py-12">
              <div className="text-center">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#9E2E29] mx-auto mb-4"></div>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <input
                            ...
                            className="w-4 h-4 text-[#9E2E29] bg-gray-700 border-gray-600 rounded focus:ring-blue-500"
                          />
                          <span
        ...
        <div className="flex-shrink-0 p-4 pb-6 border-t border-gray-800 bg-gray-900">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-[#9E2E29] font-bold text-lg">
          ...
          <div className="flex items-center gap-4">
            ...
            className="flex-1 bg-[#9E2E29] text-white py-3 px-6 rounded-lg font-medium hover:bg-[#601B19] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
            {isSubmitting
              ? "Αποθήκευση..."
