          ...
          <div className="p-4">
            <div className="flex justify-between items-start mb-2">
              ...
              <button
                ...
                className="w-8 h-8 bg-[#9E2E29] rounded-full flex items-center justify-center hover:bg-[#601B19] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loadingItemId === 3 ? (
                  <Loader2 className="w-4 h-4 text-white animate-spin" />
                ) : (
